...
class InSetTest {
	...
	@Test
	public void isMemberTest1() throws Exception {
		InSet setarray = new InSet(new int[] { 1, 2, 3, 4, 5 });
	...
	@Test
	public void subsetTest1() throws Exception {
		InSet setarray = new InSet(new int[] { 1, 2, 3, 4, 5 });
	...
	@Test
	public void subsetTest2() throws Exception {
		InSet setarray = new InSet(new int[] { 1, 2, 3, 4, 5 });
	...
	@Test
	public void unionTest1() throws Exception {
		InSet setarray1 = new InSet(new int[] { 1, 2, 3 });
